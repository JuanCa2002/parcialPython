...
from juegoMillonario.Infraestructura.persistenciaPregunta import PersistenciaPregunta

saver = Persistencia()
saver.connect()
saverPregunta = PersistenciaPregunta()
saverPregunta.connect()

def guardarPregunta():
    categoria5 = Categoria("4", "Ciencias")
    pregunta5 = Pregunta("555", "Como se llamael componente minimo que forma a los seres vivos?", ["Tejido", "Celula", "Particula", "Oxigeno"],
                         "Celula", "dificil", categoria5)
    saverPregunta.guardar_Pregunta(pregunta5)
    categoria6 = Categoria("3", "Arte")
    pregunta6 = Pregunta("666", "Quien es el autor de la obra: Cronica de una muerte anunciada?",
                         ["Pablo Neruda", "Gabriel Garcia Marquez", "Jorge Luis Borges", "Julio Cortazar"]
                         ,"Gabriel Garcia Marquez", "facil", categoria6)
    saverPregunta.guardar_Pregunta(pregunta6)
